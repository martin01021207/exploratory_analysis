...
reader.AddVariable( "corrMax_PA", corrMax_PA )
...
reader.AddVariable( "corrMax_inIce", corrMax_inIce )
...
tree_S.SetBranchAddress( "corrMax_PA", corrMax_PA )
...
tree_S.SetBranchAddress( "corrMax_inIce", corrMax_inIce )
...
tree_B.SetBranchAddress( "corrMax_PA", corrMax_PA )
...
tree_B.SetBranchAddress( "corrMax_inIce", corrMax_inIce )
