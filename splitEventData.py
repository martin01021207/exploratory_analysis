...
if __name__ == "__main__":
    ...
    tree_out_train.Branch("shower_energy", shower_energy, 'shower_energy/F')
    tree_out_train.Branch("inelasticity", inelasticity, 'inelasticity/F')
    tree_out_train.Branch("interaction_type", interaction_type, 'interaction_type/I')

    tree_out_train.Branch("trigger_time", trigger_time, 'trigger_time/D')
    ...
    tree_out_train.Branch("reco_surf_corr_z", reco_surf_corr_z, 'reco_surf_corr_z/F')
    tree_out_train.Branch("reco_surf_corr_zen", reco_surf_corr_zen, 'reco_surf_corr_zen/F')
    tree_out_train.Branch("reco_rho", reco_rho, 'reco_rho/F')
    tree_out_train.Branch("reco_phi", reco_phi, 'reco_phi/F')
    tree_out_train.Branch("reco_z", reco_z, 'reco_z/F')
    ...
    if type == "V":
        ...
        tree_out_train.Branch("averageImpulsivity_PA", averageImpulsivity_PA, 'averageImpulsivity_PA/F')
        ...
        tree_out_train.Branch("coherentImpulsivity_PA", coherentImpulsivity_PA, 'coherentImpulsivity_PA/F')
        ...
        tree_out_train.Branch("averageImpulsivity_inIce", averageImpulsivity_inIce, 'averageImpulsivity_inIce/F')
        ...
        tree_out_train.Branch("coherentImpulsivity_inIce", coherentImpulsivity_inIce, 'coherentImpulsivity_inIce/F')
        ...
        tree_out_train.Branch("averageImpulsivity_surface", averageImpulsivity_surface, 'averageImpulsivity_surface/F')
        ...
        tree_out_train.Branch("coherentImpulsivity_surface", coherentImpulsivity_surface, 'coherentImpulsivity_surface/F')
    ...
    tree_out_test.Branch("shower_energy", shower_energy, 'shower_energy/F')
    tree_out_test.Branch("inelasticity", inelasticity, 'inelasticity/F')
    tree_out_test.Branch("interaction_type", interaction_type, 'interaction_type/I')

    tree_out_test.Branch("trigger_time", trigger_time, 'trigger_time/D')
    ...
    tree_out_test.Branch("reco_surf_corr_z", reco_surf_corr_z, 'reco_surf_corr_z/F')
    tree_out_test.Branch("reco_surf_corr_zen", reco_surf_corr_zen, 'reco_surf_corr_zen/F')
    tree_out_test.Branch("reco_rho", reco_rho, 'reco_rho/F')
    tree_out_test.Branch("reco_phi", reco_phi, 'reco_phi/F')
    tree_out_test.Branch("reco_z", reco_z, 'reco_z/F')
    ...
    if type == "V":
        ...
        tree_out_test.Branch("averageImpulsivity_PA", averageImpulsivity_PA, 'averageImpulsivity_PA/F')
        ...
        tree_out_test.Branch("coherentImpulsivity_PA", coherentImpulsivity_PA, 'coherentImpulsivity_PA/F')
        ...
        tree_out_test.Branch("averageImpulsivity_inIce", averageImpulsivity_inIce, 'averageImpulsivity_inIce/F')
        ...
        tree_out_test.Branch("coherentImpulsivity_inIce", coherentImpulsivity_inIce, 'coherentImpulsivity_inIce/F')
        ...
        tree_out_test.Branch("averageImpulsivity_surface", averageImpulsivity_surface, 'averageImpulsivity_surface/F')
        ...
        tree_out_test.Branch("coherentImpulsivity_surface", coherentImpulsivity_surface, 'coherentImpulsivity_surface/F')
    ...
    if type == "V" and path_to_second_file_in:
        ...
        tree_out_train_2.Branch("shower_energy", shower_energy, 'shower_energy/F')
        tree_out_train_2.Branch("inelasticity", inelasticity, 'inelasticity/F')
        tree_out_train_2.Branch("interaction_type", interaction_type, 'interaction_type/I')

        tree_out_train_2.Branch("trigger_time", trigger_time, 'trigger_time/D')
        ...
        tree_out_train_2.Branch("reco_surf_corr_z", reco_surf_corr_z, 'reco_surf_corr_z/F')
        tree_out_train_2.Branch("reco_surf_corr_zen", reco_surf_corr_zen, 'reco_surf_corr_zen/F')
        tree_out_train_2.Branch("reco_rho", reco_rho, 'reco_rho/F')
        tree_out_train_2.Branch("reco_phi", reco_phi, 'reco_phi/F')
        tree_out_train_2.Branch("reco_z", reco_z, 'reco_z/F')

        tree_out_train_2.Branch("passed_hit_filter", passed_hit_filter, 'passed_hit_filter/I')
        tree_out_train_2.Branch("nCoincidentPairs_PA", nCoincidentPairs_PA, 'nCoincidentPairs_PA/I')
        tree_out_train_2.Branch("nHighHits_PA", nHighHits_PA, 'nHighHits_PA/I')
        tree_out_train_2.Branch("nCoincidentPairs_inIce", nCoincidentPairs_inIce, 'nCoincidentPairs_inIce/I')
        tree_out_train_2.Branch("nHighHits_inIce", nHighHits_inIce, 'nHighHits_inIce/I')
        ...
        tree_out_test_2.Branch("shower_energy", shower_energy, 'shower_energy/F')
        tree_out_test_2.Branch("inelasticity", inelasticity, 'inelasticity/F')
        tree_out_test_2.Branch("interaction_type", interaction_type, 'interaction_type/I')

        tree_out_test_2.Branch("trigger_time", trigger_time, 'trigger_time/D')
        ...
        tree_out_test_2.Branch("reco_surf_corr_z", reco_surf_corr_z, 'reco_surf_corr_z/F')
        tree_out_test_2.Branch("reco_surf_corr_zen", reco_surf_corr_zen, 'reco_surf_corr_zen/F')
        tree_out_test_2.Branch("reco_rho", reco_rho, 'reco_rho/F')
        tree_out_test_2.Branch("reco_phi", reco_phi, 'reco_phi/F')
        tree_out_test_2.Branch("reco_z", reco_z, 'reco_z/F')

        tree_out_test_2.Branch("passed_hit_filter", passed_hit_filter, 'passed_hit_filter/I')
        tree_out_test_2.Branch("nCoincidentPairs_PA", nCoincidentPairs_PA, 'nCoincidentPairs_PA/I')
        tree_out_test_2.Branch("nHighHits_PA", nHighHits_PA, 'nHighHits_PA/I')
        tree_out_test_2.Branch("nCoincidentPairs_inIce", nCoincidentPairs_inIce, 'nCoincidentPairs_inIce/I')
        tree_out_test_2.Branch("nHighHits_inIce", nHighHits_inIce, 'nHighHits_inIce/I')
    ...
    for i_event in range(nEvents):
        ...
        if type == "V":
            ...
            averageImpulsivity_PA[0] = tree_in.averageImpulsivity_PA
            ...
            coherentImpulsivity_PA[0] = tree_in.coherentImpulsivity_PA
            ...
            averageImpulsivity_inIce[0] = tree_in.averageImpulsivity_inIce
            ...
            coherentImpulsivity_inIce[0] = tree_in.coherentImpulsivity_inIce
            ...
            averageImpulsivity_surface[0] = tree_in.averageImpulsivity_surface
            ...
            coherentImpulsivity_surface[0] = tree_in.coherentImpulsivity_surface
